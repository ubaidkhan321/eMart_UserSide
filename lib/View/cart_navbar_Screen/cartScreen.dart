...
import 'package:e_commerce_app/View/cart_navbar_Screen/shipping-Screen.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Obx(() => "${controller.totalamount.value}"
                            .numCurrency
                            .text
                            .fontWeight(FontWeight.bold)
                            .color(redColor)
