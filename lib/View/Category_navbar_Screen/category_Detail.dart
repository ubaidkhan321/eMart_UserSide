...
class CategoryDetailScreen extends StatelessWidget {
  final String? ctitle;
  const CategoryDetailScreen({super.key, required this.ctitle});
                                ...
                                itemBuilder: (context, index) {
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      .make()
                                      .onTap(() {
                                        //this method is check in firebaase current user id is available or not........if yes then show red color in fav wishlist....
