                    ...
                    controller: emailcontroller,
                      ...
                      10.heightBox,
                         ...
                         onpress: ()async{
                          ...
                          await controller.islogin(context: context,semail: emailcontroller.text,spassword: passwordcontroller.text ).then((value) {
                      ...
                      Row(
                        ...
                        children: [
                            createaccount.text.color(Colors.grey).fontWeight(FontWeight.w600).make(),
                          ...
                          List.generate(
                            3, (index) => Padding(
                              ...
                              child: CircleAvatar(
                                ...
                                radius: 25,
                                child: Image.asset(Sociallist[index],
                                width: 30,)
                              ),
                            )),
                      )
